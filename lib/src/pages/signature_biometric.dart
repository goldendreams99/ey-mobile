...
class BiometricSignature extends ConsumerStatefulWidget {
  @override
  _BiometricSignatureState createState() => _BiometricSignatureState();
}

class _BiometricSignatureState extends ConsumerState<BiometricSignature> {
  @override
  void initState() {
    super.initState();
  }
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Llegó el momento de crear tu firma biométrica',
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.symmetric(horizontal: 20.0),
                      child: Text(
                        'Utilizando tus datos creá un perfil biométrico para poder firmar todo tipo de documentos.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: COLOR.white,
