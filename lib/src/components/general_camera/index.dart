...
class CustomCamera extends StatefulWidget {
  ...
  @override
  _CustomCamera createState() => _CustomCamera();
}

class _CustomCamera extends State<CustomCamera> with WidgetsBindingObserver {
  ...
  void confirm() async {
    Vibration.vibrate(duration: 100);
    Navigator.of(context).pop(uriPath);
  }
